...
import me.hgj.jetpackmvvm.demo.viewmodel.request.RequestLoginViewModel
import me.hgj.jetpackmvvm.demo.viewmodel.state.LoginRegisterViewModel
import me.hgj.jetpackmvvm.demo.viewmodel.state.LoginViewModel
 ...
 * 描述　: 登录页面
 */
class LoginNewFragment : BaseFragment<LoginViewModel, ActivityLoginBinding>() {
